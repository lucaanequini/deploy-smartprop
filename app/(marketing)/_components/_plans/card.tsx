...
export const Card = ({ title, value, approvalGoal, dailyRisk, maxLoss }: CardProps) => {
    return (
        <div className="h-[400px] w-[270px] flex flex-col gap-y-12 bg-white rounded-xl p-5 py-10 shadow-plans">

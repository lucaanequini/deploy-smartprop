...
const ApprovedPage = () => {
    ...
    return (
        <div className="w-screen mt-40 flex flex-col sm:flex-row gap-20 justify-center items-center mx-8 sm:mx-0">
            <div className="flex flex-col gap-y-3 sm:w-[45%]">
                ...
                <Button variant="green" className="rounded-3xl w-44 mt-3" onClick={() => router.push(`/login`)}>Prosseguir</Button>
            </div>
